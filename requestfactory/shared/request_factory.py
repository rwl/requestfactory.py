...
class RequestFactory(object):
    ...
    @see requestfactory.shared.testing.FakeRequestFactory
    @see requestfactory.server.testing.InProcessRequestTransport
    """
    ...
    def getHistoryToken(self, proxy_or_clazz):
        ...
        @param proxy an {@link EntityProxyId} instance or a Class object for an
        {@link EntityProxy} subclass
        @return a {@link com.google.gwt.user.client.History} compatible token
        """
        raise NotImplementedError


    def getProxyClass(self, historyToken):
    ...
    def getProxyId(self, historyToken):
    ...
    def initialize(self, eventBus, transport=None):
        """Start this request factory with a
        {@link requestfactory.gwt.client.DefaultRequestTransport} if None
        provided.
